                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <form action="{{ route('admin.import.google-books') }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700 transition-colors" onclick="return confirm('This will import 5-10 popular books from Google Books API. Continue?');">
